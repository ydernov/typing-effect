...
describe(`setStrings method tests`, () => {
  ...
  // test.each([
  //   {
  //     description: "test state when creating instance without arguments",
  //     initial: {
  //       callback: undefined,
  //       strings: undefined,
  ...
  //   },
  //   {
  //     description: "test state when creating instance without callback",
  //     initial: {
  //       callback: undefined,
  //       strings: initialStrings,
  //       expectedCallback: null,
  //       expectedStrings: initialStrings,
  //       expectedInstanceState: "initialized",
  //       expectedRunningState: "idle",
  //     },
  //     updates: [
  ...
  //   {
  //     description: "test state when creating instance without strings",
  //     initial: {
  //       callback: cb,
  //       strings: undefined,
  //       expectedCallback: cb,
  ...
  //     ],
  //   },
  // ])("$description", ({ initial, updates }) => {
  //   const te = new TypingEffect(initial.strings, initial.callback);

  //   expect(te.strings).toEqual(initial.expectedStrings);
  //   expect(te.callback).toEqual(initial.expectedCallback);
  //   expect(te.instanceState).toBe(initial.expectedInstanceState);
  //   expect(te.runningState).toBe(initial.expectedRunningState);
